...
public class IBUtils {
	...
	public static void pumpTradeEvent(final Object obj)
	        throws NoSuchMethodException, IllegalAccessException,
	        InvocationTargetException {
		IBUtils.pumpTradeEvent(obj.getClass().getName(),
		        BasicUtils.fieldsToArray(obj));
	}
	
	public static void pumpTradeEvent(final String mName,
	        final Object[] obj)
	        throws NoSuchMethodException, IllegalAccessException,
	        InvocationTargetException {
	...
	public static void pumpTradeEventWithParams(
	        final String mName,
	        final Object[] obj,
	        final Class[] param)
	        throws NoSuchMethodException, IllegalAccessException,
	...
	public static Order getLongLmt(final TriggeredOrder ord) {
	...
	public static Order getLongLmtTrail(final TriggeredOrder ord) {
		return IBUtils.getOrder("BUY", ord.getOrderType(), ord.getSize(),
		        ord.getLevel(), 0, 100, false,
	...
	public static Order getLongStop(final BuyStop ord) {
		return IBUtils.getOrder("BUY", ord.getOrderType(), ord.getSize(),
		        ord.getLevel(), ord.getLevel(), 100, false,
		        ord.getParent(), ord.isTrailPct() ? ord.getTrail() : 0,
		        !ord.isTrailPct() ? ord.getTrail() : 0, ord.getGoodAfter(),
		        ord.getGoodUntil());
	}
